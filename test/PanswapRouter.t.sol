...
import "../src/PanswapRouter.sol";
import "./mocks/MintableToken.sol";

contract PanswapRouterTest is Test {
    PanswapFactory factory;
    PanswapRouter router;
    ...
    function setUp() public {
        ...
        router = new PanswapRouter(address(factory));

        tokenA = new MintableToken("Token A", "TKNA");
        tokenB = new MintableToken("Token B", "TKNB");
        tokenC = new MintableToken("Token C", "TKNC");
