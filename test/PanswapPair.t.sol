...
contract PanswapPairTest is Test {
    ...
    function setUp() public {
        ...
        PanswapFactory factory = new PanswapFactory();
...
contract TestUser {
    function provideLiquidity(
        ...
        PanswapPair(pairAddress_).mint(address(this));
    }
    ...
    function removeLiquidity(address pairAddress_) public {
        ...
        PanswapPair(pairAddress_).burn(address(this));
    }
}
